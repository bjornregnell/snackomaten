...
* Code of conduct must adhere to [The Scala Code of Conduct](https://scala-lang.org/conduct/), which basically mean that everybody should be nice to each other.